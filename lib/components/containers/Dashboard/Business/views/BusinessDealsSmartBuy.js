...
class BusinessDealsSmartBuy extends Component {
  componentDidMount(){
            ...
            <div className="col-md-12 bus-inf-description">
              <div className="content">
                      ...
                      <a href="#"><img src="../../images/taco.png" alt=""/>Free Taco</a>
      							...
      							<li>
                      <a href="#"><img src="../../images/taco.png" alt=""/>Free Pizza</a>
                    </li>
      						</ul>
      					</div>
      					<div className="col-md-8">
      						<img src="../../images/smartbuys-coupon.png" alt="" className="img-responsive center-block"/>
...
export default BusinessDealsSmartBuy;
