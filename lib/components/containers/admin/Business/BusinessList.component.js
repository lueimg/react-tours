...
import { LoadBusinessList } from 'components/actions/business-actions';
...
class Business extends React.Component {
    ...
    componentDidMount = () => {
        this.props.actions.LoadBusinessList()
            .subscribe((list) => {
    ...
    add = () => {
        this.props.history.push({ pathname: '/admin/business/add' });
    }

    render() {
        return (
            <PageBase title="Business " navigation="Business / Home" >
    ...
    return (
        <TableRow key={props.id}>
            ...
            <TableRowColumn style={styles.columns.edit}>
                <Link className="button" to={`/admin/business/${props.id}/edit`}>
...
export default withRouter(connect(null, mapDispatchToProps)(Business));