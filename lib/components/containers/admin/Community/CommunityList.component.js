...
import { loadCommunityList } from 'components/actions';
...
class CommunityList extends React.Component {
    ...
    componentDidMount = () => {
        this.props.actions.loadCommunityList()
            .subscribe((list) => {
    ...
    add = () => {
        this.props.history.push({ pathname: '/admin/communities/add' });
    }

    render() {
        return (
            <PageBase title="Communities " navigation="Community / List" >
    ...
    return (
        <TableRow key={props.id}>
            ...
            <TableRowColumn style={styles.columns.edit}>
                <Link className="button" to={`/admin/communities/${props.id}/edit`}>
...
export default withRouter(connect(null, mapDispatchToProps)(CommunityList));