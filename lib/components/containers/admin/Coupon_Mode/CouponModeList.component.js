...
import { loadCouponModeList } from 'components/actions';

class CouponModeList extends React.Component {
    ...
    componentDidMount = () => {
        this.props.actions.loadCouponModeList()
            .subscribe((list) => {
    ...
    add = () => {
        this.props.history.push({ pathname: '/admin/coupon_used_modes/add' });
    }

    render() {
        return (
            <PageBase title="Coupon Modes" navigation="Coupon Modes / List" >
    ...
    return (
        <TableRow key={props.id}>
            ...
            <TableRowColumn style={styles.columns.edit}>
                <Link className="button" to={`/admin/coupon_used_modes/${props.id}/edit`}>
...
export default withRouter(connect(null, mapDispatchToProps)(CouponModeList));
