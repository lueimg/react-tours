...
import { loadCouponModeById, addCouponMode, updateCouponMode } from 'components/actions';
...
const rootUrl = '/admin/coupon_used_modes';

class CouponModeForm extends Component {
    ...
    componentDidMount = () => {
        ...
        if (this.props.match.params.id) {
            this.props.actions
                .loadCouponModeById(this.props.match.params.id)
                .subscribe((item) => {
                    this.setState({ ...item });
                });
        }
    ...
    render() {
        ...
        return (
            <PageBase title="Coupon Mode Form"
                navigation="Coupon Mode / Form Page">
                <div>
                    <Tabs>
                        <Tab label="General" >
                            <TextField
...
const mapDispatchToProps = () => {
    return {
        actions: {
            loadCouponModeById, addCouponMode, updateCouponMode
        }
    };
};

export default withRouter(connect(mapStateToProps, mapDispatchToProps)(CouponModeForm));
