...
import { LoadCategoriesListFull } from 'components/actions';
...
class CategoriesList extends React.Component {
    ...
    add = () => {
        this.props.history.push({ pathname: baseUrl + '/add' });
    }

    render() {
        return (
            <PageBase title="Categories " navigation="Categories / List" >
    ...
    return (
        <TableRow key={props.id}>
            ...
            <TableRowColumn style={styles.columns.edit}>
                <Link className="button" to={`${baseUrl}/${props.id}/edit`}>
